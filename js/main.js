        ...
        $(window).on('load resize', function() {
            ...
            if (currMenuType !== menuType) {
                ...
                if (currMenuType === 'mobile') {
                    ...
                    $('.btn-submenu').remove();
                    $('.page-title').css('padding-top', '115px');
                }
            } else {
                $('.page-title').css('padding-top', '115px');
            }
                ...
                submitHandler: function( form ) {
                    ...
                    $.ajax({
                        ...
                        success: function( msg ) {
                            var result, cls;                            
                            if (msg === 'Success') { result = 'Mensagem enviada com sucesso.'; cls = 'alert alert-success'; } else { result = 'Erro ao enviar mensagem.'; cls = 'alert alert-error'; } $form.prepend(
                                $('<div />', {
